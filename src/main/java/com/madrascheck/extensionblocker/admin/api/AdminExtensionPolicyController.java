package com.madrascheck.extensionblocker.admin.api;
...
public class AdminExtensionPolicyController {

    private final ExtensionPolicyService extensionPolicyService;

    public AdminExtensionPolicyController(ExtensionPolicyService extensionPolicyService) {
